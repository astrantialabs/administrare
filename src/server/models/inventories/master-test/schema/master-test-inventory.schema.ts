...
export class MasterTestKategori {
    [x: string]: any;
    @Prop({ type: MongooseSchema.Types.Number, required: true })
    id: number;
    ...
    @Prop({ type: MongooseSchema.Types.Array, required: true, ref: "MasterTestBarang" })
    barang: MasterTestBarang[];
}
...
export class MasterTestInventoryData {
    ...
    @Prop({ type: MongooseSchema.Types.Array, required: true, ref: "MasterTestKategori" })
