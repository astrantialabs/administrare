...
import { MasterTestBarang, MasterTestInventoryDataDocument, MasterTestKategori } from "./schema/master-test-inventory.schema";
...
export class MasterTestInventoryController {
     ...
     */
    constructor(private readonly masterTestInventoryService: MasterTestInventoryService, private readonly utilsService: UtilsService) {}
    ...
    public async masterGetBarangAllByKategoriId(@Param("category_id", new ParseIntPipe()) category_id: number): Promise<MasterTestBarang[]> {
    ...
    public async masterGetKategoriByKategoriId(@Param("category_id", new ParseIntPipe()) category_id: number): Promise<MasterTestKategori> {
    ...
    public async masterGetBarangNameByKategoriIdAndBarangId(
        ...
        return await this.masterTestInventoryService.masterGetBarangNameByKategoriIdAndBarangId(2022, category_id, item_id);
    }
    ...
    public async masterUpdateBarangByKategoriIdAndItemId(
        ...
        return await this.masterTestInventoryService.masterUpdateBarangByKategoriIdAndItemId(2022, category_id, item_id, barang);
    }
    ...
    public async masterDeleteKategoriByKategoriId(@Param("category_id", new ParseIntPipe()) category_id: number): Promise<MasterTestKategori> {
    ...
    public async masterDeleteBarangByKategoriIdAndBarangId(
        ...
        return await this.masterTestInventoryService.masterDeleteBarangByKategoriIdAndBarangId(2022, category_id, item_id);
    }
